      ...
      <table id="comments-table" class="display">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td><?= htmlspecialchars(substr($fetch_comment['comment'], 0, 50)) ?>...</td>
               <td><?= htmlspecialchars($fetch_comment['user_name'] ?? 'Unknown'); ?></td>
               <td><?= htmlspecialchars($fetch_comment['post_title'] ?? 'Unknown'); ?></td>
               <td>
                  <a href="view_comments.php?delete=<?= $fetch_comment['id']; ?>" 
