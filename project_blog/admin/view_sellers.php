...
if(isset($_GET['delete'])){
   ...
   $delete = $conn->prepare("DELETE FROM `seller` WHERE seller_id = ?");
...
<head>
   ...
   <!-- Optional inline CSS if not in admin_style.css -->
   <style>
...
<section class="accounts">
   ...
   <h1 class="heading">Registered Sellers</h1>
      ...
      <table id="sellers-table" class="display">
         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <a href="view_sellers.php?delete=<?= $fetch_seller['seller_id']; ?>" 
